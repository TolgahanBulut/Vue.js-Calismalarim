            ...
            <form>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" id="password" v-model.lazy="userData.password" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="age">Yaş</label>
                    <input type="number" id="age" v-model.number="userData.age" class="form-control">
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>
                      <input v-model="userData.interest" type="checkbox" value="yazilim"> Yazılım
                    </label>
                    <label>
                      <input v-model="userData.interest" type="checkbox" value="donanim"> Donanım
                    </label>
                  </div>
    ...
    data(){
      return {
        userData : {
          ...
          interest : [],
          gender : '',
          cities : ["Istanbul","Edirne","Tekirdağ","Kırklareli","New York"],
          selectedCity : 'Edirne'
        },
        switched : true,
        isSubmit : false
